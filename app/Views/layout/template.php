...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href=<?= base_url("/karyawan/tambah"); ?>>Tambah Karyawan</a>
                    </div>
                </div>
</li>
<li class="nav-item">
    <a class="nav-link collapsed" href=<?= base_url("/karyawan/detail"); ?>>
        <i class="fas fa-fw fa-user"></i>
        <span>Kinerja Karyawan</span>
    </a>
</li>
<?php endif; ?>
<?php if(session()->get('akses')=='Pegawai') : ?>
    <li class="nav-item">
    <a class="nav-link collapsed" href=<?= base_url("/absen/karyawan"); ?>>
        <i class="fas fa-fw fa-user"></i>
        <span>Absen</span>
    </a>
</li>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                    ...
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Zarus Kawulur</span>
                    <img class="img-profile rounded-circle"
                        src="<?=base_url('sb/img/profile/diko.png')?>">
...
<footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Zarus Kawulur <?=date ('Y')?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
